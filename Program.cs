...
namespace HelloWorld {
    class Program {
        ...
        static async Task RecognizeSpeechAsync() {
            ...
            var config = SpeechConfig.FromSubscription("7c85187a2edb42d1b3aac4188d0953f2", "southcentralus");
            
            // Agregamos el archivo de audio, en este caso es un hola.
            //using (var audioInput = AudioConfig.FromWavFileInput("hola.wav"))  //Archivo de Audio de Sherpa FernandaOchoa
